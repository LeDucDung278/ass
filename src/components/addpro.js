const formAdd = {
    render() {
        ...
        <h1 class="tw-text-2xl">Thêm sản phẩm</h1>
        <form id="form-add-pro">
            <div class="tw-mb-3">
                ...
                <input type="text" class="tw-border tw-border-gray-300 tw-p-2 tw-w-full" name="name" id="name" value="">
            </div>
            ...
            <div class="tw-mb-3 tw-grid tw-grid-cols-2 tw-gap-6">
                <div>
                    ...
                    <input type="text" class="tw-border tw-border-gray-300 tw-p-2 tw-w-full" name="price" id="price" value="">
                </div>
                <!-- ... -->
                <div>
                    ...
                    <input type="text" class="tw-border tw-border-gray-300 tw-p-2 tw-w-full" name="quantity" id="quantity" value="">
                </div>
            </div>
            ...
            <div class="tw-mb-3">
                ...
                <textarea class="tw-w-full sec tw-p-3 tw-h-60 tw-border tw-border-gray-300 "name="desc" id="desc" placeholder="Mô tả sản phẩm"></textarea>
            </div>
